...
export const financeInvoiceStatusLabels:Record<FinanceInvoiceStatus,string>={draft:"Taslak",issued:"Kesinleştirildi",partially_paid:"Kısmen tahsil edildi",paid:"Tahsil edildi",cancelled:"İptal edildi"};
